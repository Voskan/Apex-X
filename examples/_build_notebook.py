...
cells.append(code([
    ...
    "config = ApexXConfig(model=ModelConfig(backbone='vit_l', lora_rank=8, num_classes=24), train=TrainConfig(batch_size=BATCH_SIZE, image_size=IMAGE_SIZE))\n",
    "model = TeacherModelV3(config).to(DEVICE)\n",
